...
CREATE TABLE `joblistings` (
  ...
  `desired_qualification_id` bigint DEFAULT NULL,
...
INSERT INTO `joblistings` VALUES (39,'Awesome Tech company','Ideal Solutions',1,8,'Really Cool java stuff',1,15000),(41,'Awesome Tech company','Ideal Solutions',1,8,'Really Cool java stuff',1,15000);
